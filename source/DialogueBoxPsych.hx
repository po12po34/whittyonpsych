...
class DialogueBoxPsych extends FlxSpriteGroup
{
	...
	function addCharacter(char:FlxSprite, name:String) {
		switch(name) {
			...
			case 'bf-w':
				char.frames = Paths.getSparrowAtlas('dialogue/boyfriendPort');
				char.animation.addByPrefix('talkIdle', 'BF portrait enter instance', 24, true); //Dialogue ended
			...
			case 'whitty-a':
				char.frames = Paths.getSparrowAtlas('dialogue/whittyPort');
				char.animation.addByPrefix('talkIdle', 'Whitty Portrait Agitated instance', 24, true);
				char.animation.addByPrefix('talk', 'Whitty Portrait Agitated instance', 24, true);
				char.y += 70;

			case 'whitty-c':
				char.frames = Paths.getSparrowAtlas('dialogue/whittyPort');
				char.animation.addByPrefix('talkIdle', 'Whitty Portrait Crazy instance', 24, true);
				char.animation.addByPrefix('talk', 'Whitty Portrait Crazy instance', 24, true);
				char.y += 70;
