	...
	override public function create()
	{
		...
		switch (SONG.song.toLowerCase())
		{
			...
			case 'lo-fight' | 'overhead':
						...
						defaultCamZoom = 0.9;
						curStage = 'whitty';
						wBg = new FlxSprite(-500, -300).loadGraphic(Paths.image('whittyBack', 'week7'));
						{
						  wBg.antialiasing = true;
						  wBg.scrollFactor.set(0.9, 0.9);
						  wBg.active = false;
			
						  wstageFront = new FlxSprite(-650, 600).loadGraphic(Paths.image('whittyFront', 'week7'));
				...
				case 'ballistic' | 'ballistic-old':
						...
						wBg = new FlxSprite(-500, -300).loadGraphic(Paths.image('whittyBack', 'week7'));
						{
							trace('pogging');
							wBg.antialiasing = true;
							var bgTex = Paths.getSparrowAtlas('BallisticBackground', 'week7');
							...
							wBg.alpha = 0;
							nwBg.alpha = 1;
							funneEffect = new FlxSprite(-600, -200).loadGraphic(Paths.image('thefunnyeffect', 'week7'));
